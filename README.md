...
![切片 4 (1)](https://github.com/teemoyangyyq/TeeGo/assets/33918440/c532d61c-9baf-4c75-86fc-f202728f6eaa)
   ...
   4.在路由前缀树建立成功后，遍历前缀树，做两件事：<br><br>
    <br><br>  4.1  把不带路径参数的路由放进一个全局map，key为路由index,value为路由索引<br><br>
     <br><br>  4.2 存两个路由索引map，key为路由索引。第一个value存路由对应所有方法，包括group分组方法，这些分组方法可以通过addroute叶子节点反查引擎;第二个value存路由对应路由路径参数数组，按先后顺序存放<br><br>
